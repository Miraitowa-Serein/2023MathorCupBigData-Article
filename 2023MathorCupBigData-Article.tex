...
\keyword{计算机视觉；卷积神经网络；支持向量机；特征提取；可视化多维评估}
\begin{document}
	\begin{abstract}
...
\begin{table}[htbp]
	...
	\scalebox{0.9}{
	  ...
	  \midrule
	  \multirow{4}[2]{*}{precision} & 0：potholes & 0.50  & 0.90  & 0.89  \\
			& 1：normal & 0.89  & 0.88  & 0.92  \\
			& macro & 0.70  & 0.89  & 0.91  \\
			& weighted & 0.84  & 0.89  & 0.91  \\
	  \midrule
	  \multirow{4}[2]{*}{recall} & 0：potholes & 0.25  & 0.88  & 0.93  \\
			& 1：normal & 0.96  & 0.90  & 0.88  \\
			& macro & 0.61  & 0.89  & 0.90  \\
			& weighted & 0.87  & 0.89  & 0.90  \\
	  \midrule
	  \multirow{4}[2]{*}{f1-score} & 0：potholes & 0.33  & 0.89  & 0.91  \\
